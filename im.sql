...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 01, 2019 at 06:24 PM
...
('1jb16cs000', 'chillwertya', 'zzz', '2019-05-22', 1234567890, 'a@ggmail.com', 'qwerty', 'poiuytre', 'bnm', 567890, 9876543210, 'w@wpmail.com');
...
INSERT INTO `student_admission` (`stud_id`, `course_id`, `trans_id`, `trans_proof_url`, `bill_status`) VALUES
('1jb16cs000', 'C0005', 'ID1558551195', 'demoUrl', 1);
...
DROP TABLE IF EXISTS `student_workshop`;
...
INSERT INTO `student_workshop` (`ws_id`, `sid`) VALUES
('ws004', '1jb16cs749');
...
--
-- Dumping data for table `wokrshop`
--

INSERT INTO `wokrshop` (`ws_id`, `ws_dutration`, `ws_name`, `ws_cost`) VALUES
('ws001', 4, 'Web technologies', 3000),
('ws002', 3, 'IoT', 4000),
('ws003', 5, 'Machine learning', 6000),
('ws004', 4, 'Cyber security', 5600),
('ws005', 2, 'Graphic design', 4200);
COMMIT;
